...
import com.vedri.mtp.frontend.support.web.HeaderUtil;
...
public class UserResource {
	...
	@Autowired
	public UserResource(CassandraUserDao cassandraUserDao, UserManager userManager) {
	...
	public ResponseEntity<User> createUser(@RequestBody User user) throws URISyntaxException {
		...
		User result = cassandraUserDao.save(user);
		...
		return cassandraUserDao
				...
				.map(user -> {
                    ...
                    return ResponseEntity.ok()
                            ...
                            .body(new ManagedUserDTO(cassandraUserDao.findOne(managedUserDTO.getId()).get()));
                })
