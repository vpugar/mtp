...
public class PlacedDayTransactionAggregationByCurrencyBuilder
		extends DayTransactionAggregationByCurrencyBuilderTemplate {

	public PlacedDayTransactionAggregationByCurrencyBuilder(
			StreamBuilder<?, JavaDStream<Transaction>> prevBuilder, String keyspace) {
		super(prevBuilder, keyspace, TableName.PT_DAY_AGGREGATION_BY_CURRENCY);
	}
